        ...
        {!wageringComplete && (
          <div className="bonus-banner">
            ...
            <span className="bonus-banner-text">
              You have a <strong>{Number(bonusBalance || 0).toFixed(0)} ETB</strong> coupon balance. Wager{' '}
              <strong>{WAGERING_MULTIPLIER}x</strong> that amount (ETB {wageringTarget.toFixed(0)}) to unlock it for withdrawal.
            </span>
          </div>
        )}
