...
/* ------------------------------------------------------------------ */
// Only four buttons. Deposit, Withdraw, Guide, Rules, Help, Promo code and
// Language are deliberately not included. The label text is what Telegram
// sends back when the user taps a button, so these strings are matched exactly.
const MENU = {
  profile: '👤 ፕሮፋይል',
  balance: '💰 ሂሳብ',
  invite: '🔗 ጋብዝ & አግኝ',
...
const mainMenu = () => ({
  ...
  resize_keyboard: true,   // compact buttons instead of a huge keyboard
  is_persistent: true,     // stays visible instead of collapsing
});
