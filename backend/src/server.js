...
const CORS_ORIGIN = process.env.CORS_ORIGIN || '*'; // set to your Vercel URL in production
...
function createBot() {
  if (!BOT_TOKEN) {
    console.warn('BOT_TOKEN not set — bot will not start. Set it to enable Telegram bot features.');
    return null;
  }
